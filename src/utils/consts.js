...
const CORREIOS_URL = 'https://webservice.correios.com.br/service/rastro';
...
const VALID_INITIALS = {
    ...
    BK: 'Etiqueta Lógica Remessa Econômica s/AR',
    BL: 'Etiqueta Lógica Remessa Econômica c/AR',
    BO: 'Etiqueta Lógica Registro Urgente',
    BR: 'Etiqueta Física Registro Urgente',
    BT: 'Etiqueta Lógica Remessa Econômica c/AR',
    ...
    OK: 'Etiqueta lógica SEDEX',
    OL: 'Etiqueta lógica PAC',
    OM: 'Etiqueta lógica SEDEX',
    PA: 'Passaporte',
    ...
    QE: 'PAC Econômico',
    QF: 'PAC',
    QG: 'PAC Etiqueta Lógica',
    QH: 'PAC Etiqueta Lógica',
    QJ: 'PAC',
    QK: 'PAC',
    QL: 'PAC',
    QM: 'PAC',
